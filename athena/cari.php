...
<div class="full">
	...
	<?php
	$bukucari = mysql_query("SELECT * FROM buku WHERE buku_judul LIKE '$_GET[id]%'");
	...
	else {echo "MAAF, BUKU DENGAN INISIAL ''$_GET[id]'' BELUM ADA";}
	?>
	<div class="judul-full">
	E-BOOK PDF
	</div>
	<?php
	$pdfcari = mysql_query("SELECT * FROM pdf WHERE pdf_judul LIKE '$_GET[id]%'");
	...
	else {echo "MAAF, E-BOOK PDF DENGAN INISIAL ''$_GET[id]'' BELUM ADA";}
	?>
	<div class="judul-full">
	E-BOOK FLASH
	</div>
	<?php
	$flashcari = mysql_query("SELECT * FROM flash WHERE flash_judul LIKE '$_GET[id]%'");
	...
	else {echo "MAAF, E-BOOK FLASH DENGAN INISIAL ''$_GET[id]'' BELUM ADA";}
	?>
	</div>
	</div>
