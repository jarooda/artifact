...
include "config/class_paging.php";
	...
	$flashlihat = mysql_query("SELECT * FROM flash ORDER BY flash_judul LIMIT $posisi,$batas");
?>
<!DOCTYPE html>
<html>
<head>
...
<div class="full">
	...
	while ($pc = mysql_fetch_array($flashlihat)){
	?>
	<?php
	echo "
	<ul>
		<li><a href='file_flash/$pc[flash_kode]/' target=_blank>$pc[flash_judul]</a></li>
	</ul>
	";
	}
